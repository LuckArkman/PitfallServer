...
public class PixTransactionRepositorio : IPixTransactionRepositorio<PixTransaction>
{
    private readonly IConfiguration _configuration;
    // Sugestão: Alterar para private readonly ou protected para melhor encapsulamento
    protected IMongoCollection<PixTransaction> _collection;
        ...
        string collectionName)
    {
        ...
        _collection = _mongoDatabase.GetCollection<PixTransaction>(collectionName);
    }

    public async Task<PixTransaction?> InsertOneAsync(PixTransaction document)
    {
